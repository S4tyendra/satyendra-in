...
- **Restart the Service**: If the reader is fine but the app isn't responding, a technician may need to restart the backend service (see the [Deployment Guide](/docs/iiitkota/nfc-main-gate/deployment)).
...
- **Action**: You may need to add this student to the database. Follow the [Adding Users](/docs/iiitkota/nfc-main-gate/users/adding) guide.
...
The system creates new log files every month. To view historical data, you need to access the database files in the [Data Folder](/docs/iiitkota/nfc-main-gate/data/finding).
